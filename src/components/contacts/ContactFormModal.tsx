...
import type { Contact, ContactType, CreateContactRequest, UpdateContactRequest } from '@/types/contact';

interface ContactFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (contactData: CreateContactRequest | UpdateContactRequest) => Promise<void>;
      ...
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          <div className="space-y-2">
            <Label htmlFor="contact-name">Nome <span className="text-red-500">*</span></Label>
            <Input
              id="contact-name"
              value={name}
          ...
          <div className="space-y-2">
            <Label htmlFor="contact-type">Tipo <span className="text-red-500">*</span></Label>
